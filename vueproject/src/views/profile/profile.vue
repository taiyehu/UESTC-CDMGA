        ...
        <div class="profile-header">
          <div class="avatar-select-group">
            <template v-if="isSelf">
              <el-tooltip content="点击修改资料" placement="bottom">
                <div
                  style="display: inline-block; cursor: pointer"
                  @click="goToSettings('avatar')"
                >
                  <el-avatar
                    :size="128"
                    :src="
          ...
          <div class="profile-right">
            ...
            <div
              ...
              style="color: var(--color-text-primary); margin-bottom: 10px"
            >
              资料审核通过后才会显示头像和签名
            </div>
            <div v-if="isSelf" style="margin-top: 10px">
              <el-button type="primary" @click="goToSettings">设置个人资料</el-button>
            </div>
          </div>
        ...
        >
          ...
          <template v-slot:title>
            ...
            >
              ...
              <div style="color: var(--color-text-primary); font-size: 12px">
                ...
                <span v-else-if="errorMap[activity.id]" style="color: var(--color-text-primary)"
                  >加载失败</span
                >
              </div>
            </div>
          ...
          <div class="activity-scores">
            ...
            <div
              ...
              style="text-align: center; padding: 12px; color: var(--color-text-primary)"
            >
            ...
            <div
              v-if="
                ...
                "
              style="text-align: center; color: var(--color-text-primary); padding: 12px"
            >
              暂无成绩
            </div>
          </div>
